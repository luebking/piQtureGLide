...
public:
    ...
    */
    ...
    inline bool providesShaders()
    {
        return _providesShaders;
    }
...
//    ~QGLImage();
    ...
    */
    ...
    inline QGLImageViewer *parent() const
    {
        return _parent;
    }
...
//    int positioni(Axis a);
    ...
    */
    inline void boxBlur(float factor, int msecs = 0)
    {
        blur(factor, msecs, 0);
    }
    /**
    * See boxBlur()
    */
    inline void tunnel(float factor, int msecs = 0)
    {
        blur(factor, msecs, 1);
    }
    ...
    inline void setClipRect(QRect &r, bool update = true)
    {
        setClipRect(r.x(), r.y(), r.width(), r.height(), update);
    }

    inline void setClipping(bool enabled = true)
    {
        _hasClipping = enabled;
    }
    ...
    */
    inline GLhandleARB shaderProgram()
    {
    ...
    */
    inline void setShaderProgram(QGLImage &img)
    {
        _shaderProgram = img._shaderProgram;
    }
